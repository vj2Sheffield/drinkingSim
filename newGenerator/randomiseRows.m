...
function randRows = randomiseRows(USA_data, nAgents)
    ...
    randRows = random_USA_data(1:nAgents, :); % Write the acceptable matrix to a csv
    writematrix(randRows, 'RandUSA_data.csv'); % Write the acceptable matrix to a csv
